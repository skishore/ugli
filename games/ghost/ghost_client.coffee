class @GhostClient extends UGLIClient
  ...
  make_game_ui: ->
    ...
    console.log 'GhostClient.make_game_ui has not been implemented.'

  handle_update: (players, view) ->
    # Takes a new list of players and a new view and updates the game UI.
    console.log 'GhostClient.handle_update has not been implemented.'
